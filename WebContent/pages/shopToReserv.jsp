		...
		<div class="container">
			<fieldset>
				...
				<div class="row justify-content-center">
					...
					<div name="productArea101" id="productArea101"></div>
				</div>
			</fieldset>
		</div>
	</div>
				...
				productArea.innerHTML += html;
					...
					html +=
						...
						'<div class="col-sm-4 col-md-4" style="display:none">'
								+ '<div class="boxes pointer"  style="display:none" onclick="productDetail('
								+ allProduct[i].p_id + ')">' +
								// 					  '<div onclick="productDetail('+allProduct[i].p_id+')">'+
								'<div class="big bigimg" style="display:none">' +
								// 					  '<div>'+
								'<img src="'+imgURL+'">' + '</div>'
								+ '<p class="product-name" style="visibility:hidden>' + allProduct[i].p_name
								+ '</p>' + '<p class="product-price" style="display:none">$'
								+ allProduct[i].p_price + '</p>' + '</div>' + '</div>';
...
// 				productArea.innerHTML += html;
		...
		function productDetail(id) {
			...
			if (jumpResult == "success") {
				window.location.href = "${cp}/pages/productResdetail.jsp";
			}
		}
